...
import numpy as np
import sys
sys.path.insert(0,'/home/dcornu/Work/MINERVA/YOLO_Pascal_CIANNA/CIANNA_exp/src/build/lib.linux-x86_64-3.8')
...
cnn.init_network(dims=np.array([28,28,1]), out_dim=10, \
		bias=0.1, b_size=64,comp_meth='C_CUDA', dynamic_load=1, mixed_precision=1) #Change to C_BLAS or C_NAIV
