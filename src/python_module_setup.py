...
setup(name = 'CIANNA', 
	...
	extra_objects=['conv_layer.o', 'dense_layer.o', 'pool_layer.o', 'norm_layer.o', 'activ_functions.o', 'initializers.o', 'vars.o', 'auxil.o', 'naiv/naiv_dense_layer.o', 'naiv/naiv_conv_layer.o', 'naiv/naiv_pool_layer.o', 'naiv/naiv_norm_layer.o'] + cuda_obj + blas_obj,
